document.addEventListener("DOMContentLoaded", function() {
    ...
    function checkVictoryConditions() {
        ...
        const victoryImages = ['img1.png', 'img2.png', 'img3.png', 'img4.png', 'img5.png'];
        const zeroScoreImages = ['goat1.png', 'goat2.png', 'goat3.png', 'goat4.png', 'goat5.png'];
        const victorySounds = ['victory.mp3'];
        const specialSounds = ['goat.mp3'];
